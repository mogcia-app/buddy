      ...
      <section className="py-16 bg-white border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-blue-50 p-8 border border-teal-100/50">
              <div className="w-16 h-16 bg-gradient-to-r from-teal-600 to-blue-600 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white p-8 md:p-12 shadow-xl border border-gray-100/50">
              <form className="formrun space-y-6" action="https://form.run/api/v1/r/14wyo9q1lhd96ecsdndkl2l4" method="post">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-teal-600 text-white py-4 px-6 font-medium text-lg hover:from-green-700 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
                >
                  無料相談を申し込む
                </button>
