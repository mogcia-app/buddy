      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 border border-blue-100/50">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center mb-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 border border-purple-100/50">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 border border-indigo-100/50">
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-600 to-blue-600 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 p-8 border border-green-100/50">
              <div className="w-16 h-16 bg-gradient-to-r from-green-600 to-teal-600 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 p-8 border border-orange-100/50">
              <div className="w-16 h-16 bg-gradient-to-r from-orange-600 to-red-600 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-8 border border-yellow-100/50">
              <div className="w-16 h-16 bg-gradient-to-r from-yellow-600 to-orange-600 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <form className="formrun space-y-6" action="https://form.run/api/v1/r/fiuyrd8uqjprxgdbqylv96kg" method="post">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
                    placeholder="山田 太郎"
                  />
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 px-6 font-medium text-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
                >
                  無料相談を申し込む
                </button>
