...
export default function Restaurant() {
  return (
    <div className="min-h-screen">
      ...
      {/* 過去の提供実績・事例：写真ギャラリー形式 */}
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-12">
            <span className="text-sm font-medium text-emerald-700 tracking-wider uppercase">Past Works</span>
            <h3 className="text-3xl md:text-5xl font-light text-gray-900 mb-4">過去のイベントで提供した料理例</h3>
            <div className="w-16 h-px bg-gradient-to-r from-transparent via-emerald-500 to-transparent mx-auto mb-4"></div>
            <p className="text-sm text-red-500">※このページの料理は過去の実績紹介です。現在ご注文いただけるメニューではありません。</p>
          </div>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
            {/* 料理写真のみ表示（例） */}
            
            <div className="relative group">
              <Image src="/4.jpg" alt="料理写真2" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
            <div className="relative group">
              <Image src="/8.jpg" alt="料理写真3" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
            <div className="relative group">
              <Image src="/9.jpg" alt="料理写真4" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
            <div className="relative group">
              <Image src="/5.jpg" alt="料理写真5" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
            <div className="relative group">
              <Image src="/6.jpg" alt="料理写真6" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
            <div className="relative group">
              <Image src="/7.jpg" alt="料理写真7" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
           
            {/* サラダ系追加 */}
            <div className="relative group">
              <Image src="/11.jpg" alt="サラダ写真1" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
            <div className="relative group">
              <Image src="/12.jpg" alt="サラダ写真2" width={600} height={400} className="w-full h-64 object-cover shadow-md" />
            </div>
