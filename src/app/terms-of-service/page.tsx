      ...
      <section className="bg-gradient-to-br from-slate-600 via-gray-600 to-slate-700 text-white py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-light mb-8">
            利用規約
            <span className="block font-medium text-3xl md:text-4xl mt-4">Terms of Service</span>
          </h1>
          ...
          <p className="text-lg md:text-xl text-slate-100 max-w-4xl mx-auto leading-relaxed">
            株式会社バディが提供するサービスをご利用いただく際の<br className="hidden md:block" />
            利用規約をご確認ください。
          </p>
        </div>
      </section>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="mb-12">
              <p className="text-gray-600 mb-8">
                この利用規約（以下「本規約」といいます）は、株式会社バディ（以下「当社」といいます）がこのウェブサイト上で提供するサービス
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <p>3. 本規約の規定が前条の個別規定の規定と矛盾する場合には、個別規定において特段の定めなき限り個別規定の規定が優先されるものとします。</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>1. ユーザーは、本サービスの有料部分の対価として、当社が別途定め、本ウェブサイトに表示する料金を、当社が指定する方法により支払うものとします。</p>
