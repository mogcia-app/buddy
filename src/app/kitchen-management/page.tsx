        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group">
              <div className="bg-gradient-to-br from-slate-50 to-indigo-50/30 rounded-3xl p-6 border border-gray-100/50 group-hover:shadow-xl transition-all duration-300">
                <Image
                  src="/kondate2.png"
                  alt="お正月の特別御膳"
                  width={600}
                ...
                <div className="text-center">
                  <h4 className="text-xl font-medium text-gray-900 mb-3">季節の特別御膳</h4>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    お正月やお祝いの日には、季節感溢れる特別な御膳をご提供。
                    美しい盛り付けと伝統的な味付けで、特別な日を彩ります。
                  </p>
                  <div className="flex flex-wrap gap-2 justify-center">
                    <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">季節メニュー</span>
                    <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">伝統料理</span>
                    <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">特別な日対応</span>
                  </div>
                </div>
              </div>
              
              {/* 装飾要素 */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-indigo-400/15 to-blue-500/15 rounded-full blur-xl"></div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-gradient-to-br from-slate-50 to-indigo-50/30 rounded-3xl p-6 border border-gray-100/50 group-hover:shadow-xl transition-all duration-300">
                ...
                />
                <div className="text-center">
                  <h4 className="text-xl font-medium text-gray-900 mb-3">特別なデザート</h4>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    誕生日やイベントには、華やかで美味しいデザートをご用意。
                    利用者様の笑顔と喜びを第一に考えた、心のこもった手作りデザートです。
                  </p>
                  <div className="flex flex-wrap gap-2 justify-center">
                    <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">手作りデザート</span>
                    <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">イベント対応</span>
                    <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">個別対応</span>
                  </div>
                </div>
              </div>
              
              {/* 装飾要素 */}
              <div className="absolute -top-4 -left-4 w-20 h-20 bg-gradient-to-r from-blue-400/15 to-indigo-500/15 rounded-full blur-xl"></div>
            </div>
          </div>

          {/* 料理の特徴 */}
          <div className="mt-20 grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gradient-to-br from-slate-50 to-indigo-50/30 rounded-2xl border border-gray-100/50">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  <h4 className="text-xl font-medium text-gray-900 mb-2">ISO 22000認証</h4>
                  <p className="text-gray-600">
                    食品安全マネジメントシステムの国際規格であるISO 22000の
                    認証を取得しています。
                  </p>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-indigo-50/30 p-8 rounded-3xl border border-gray-100/50">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">特別養護老人ホーム </h4>
